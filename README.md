...
This project demonstrates **AI Agents, FastAPI, LLMs, memory, and real-world decision making** in a production-grade fitness application.
...
- Tracks daily workouts (sets, reps, weight)
- Tracks meals and calculates calories & macros
- Tracks body stats (weight, waist, etc.)
- Sets fitness goals
- Detects progress or stagnation
- Automatically adjusts diet and training
- Talks like a coach, not a chatbot
...
- Sets protein & carb targets
- Creates a weekly training & diet plan
- Adjusts it dynamically based on results
